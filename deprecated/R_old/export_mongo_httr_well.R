...
#' * httr_cell_atlas
#' * httr_tox21_cpp2
#' @importFrom httrlib openMongo getWellInfo getWellCounts
#' @export export_mongo_httr_well
#-------------------------------------------------------------------------------------
export_mongo_httr_well <- function(db="httr_cell_atlas",collection="httr_well_trt",dir="../input/rawdata/cellatlas/") {
  ...
  collection <- openMongo(db_host=my_host, db_name=db,collection=collection)
