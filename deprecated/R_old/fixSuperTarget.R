...
fixSuperTarget <- function(do.read=T,
  ...
  if(do.read) {
    ...
    MAT <<-SIGNATURE_CR
    file <- paste0("../output/signature_conc_resp_summary/replaced/SIGNATURE_CR_",sigset,"_",dataset,"_",method,"_0.05_conthits.RDS")
  ...
  SIGNATURE_CR <- mat
  file <- paste0("../output/signature_conc_resp_summary/fixed/SIGNATURE_CR_",sigset,"_",dataset,"_",method,"_0.05_conthits.RDS")
  cat("saving ...\n",file,"\n")
  saveRDS(SIGNATURE_CR,file)
}
