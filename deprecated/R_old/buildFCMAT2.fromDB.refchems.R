...
#' @export buildFCMAT2.fromDB.refchems
#--------------------------------------------------------------------------------------
...
#  mat <- mat[is.element(mat$sample_key,sample_map$sample_key),]
  ...
  file <- paste0(dir,"CHEM_DICT_",dataset,"_refchems.RDS")
  saveRDS(CHEM_DICT, file)
  ...
  cat("  export FCMAT2\n")
  FCMAT2 <- matfc
  file <- paste0(dir,"FCMAT2_",dataset,"_refchems.RDS")
  saveRDS(FCMAT2, file)
  print(dim(FCMAT2))
  ...
  file <- paste0(dir,"FCMAT2.FCoverSE.",dataset,"_refchems.RDS")
  saveRDS(FCMAT2.FCoverSE,file)

  FCMAT2.PV <- matpv
  print(dim(FCMAT2.PV))
  file <- paste0(dir,"FCMAT2.PV.",dataset,"_refchems.RDS")
  saveRDS(FCMAT2.PV,file)

  FCMAT2.SE <- matse
  print(dim(FCMAT2.SE))
  file <- paste0(dir,"FCMAT2.SE.",dataset,"_refchems.RDS")
  saveRDS(FCMAT2.SE,file)
  flush.console()
}
