...
superTargetStats <- function(do.load=F,
  ...
  if(do.load) {
    file = paste0("../output/super_target_boxplot/",celltype,"/super_target_boxplot_",celltype,"_",dataset,"_",sigset,"_",method,"_",hccut,"_",tccut,"_",cutoff,"_all.RDS")
    print(file)
    RES <<- readRDS(file)
  }
  mat = RES
