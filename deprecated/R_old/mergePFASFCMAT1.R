...
#' @param file1 The name of the input file
#' @param file2 The name of the input file
...
#' @export mergePFASFCMAT1
#--------------------------------------------------------------------------------------
mergePFASFCMAT1 <- function(dataset="heparg2d_toxcast_pfas_pe1_normal_v2",
                            file1="httr_heparg2d_toxcast_pfas_FCmat1-meanncnt0_5-plateteffect_1-shrinkage_normal.RDS",
                            file2="httr_pfas_replace_heparg_FCmat1-meanncnt0_5-plateteffect_1-shrinkage_normal.RDS",
