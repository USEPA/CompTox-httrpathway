...
pathwayBuilder_bhrr = function(){
  load("Z:/httrv07/input/processed_pathway_data/msigdb_PATHWAYS.RData")
  ...
  load("Z:/httrv07/input/processed_pathway_data/RYAN_PATHWAYS.RData")
  load("Z:/httrv07/input/processed_pathway_data/bioplanet_PATHWAYS.RData")
