#' HTTr Fit
#' 
#' Concentration response curve fitting for HTTr.
#' 
#' All models are monotonic and equal to 0 at 0 concentration (zero background).
...
#'   do.plot = TRUE)
httrFit <- function(conc, resp, cutoff, force.fit = FALSE, bidirectional = TRUE, verbose = FALSE, do.plot = F,
