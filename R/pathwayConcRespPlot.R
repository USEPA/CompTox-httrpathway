...
#'
#' Plots a concentration response curve for one sample/pathway combination.
#'
#' row is one row of PATHWAY_CR, the pathwayConcResp output.
#'
...
pathwayConcRespPlot <- function(row,CYTOTOX) {
  ...
  #Bottom left info
  text(xplot[1],0.85*ymin,paste("class: ",pathway_class,"\nsize: ",pathway_size,"\nmethod:",
